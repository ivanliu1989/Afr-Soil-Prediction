var XWiki = (function (XWiki) {
  ...
  function init(){
    var sources = [
        ...
        name : "Document name",
        varname : 'input',
        script : "/xwiki/bin/get/XWiki/SuggestLuceneService?outputSyntax=plain&query=name:__INPUT__* OR web:__INPUT__*&nb=3&",
        icon : "/xwiki/resources/icons/silk/page_white_text.gif",
        highlight:  true       },
                      {
        name : "Document content",
        varname : 'input',
        script : "/xwiki/bin/get/XWiki/SuggestLuceneService?outputSyntax=plain&query=__INPUT__*&nb=3&",
        icon : "/xwiki/resources/icons/silk/page_white_text.gif",
        highlight:  false       },
                      {
        name : "Attachment name",
        varname : 'input',
        script : "/xwiki/bin/get/XWiki/SuggestLuceneService?outputSyntax=plain&query=name:__INPUT__* AND type:attachment&nb=3&",
        icon : "/xwiki/resources/icons/silk/attach.gif",
        highlight:  true       },
                      {
        name : "Attachment content",
        varname : 'input',
        script : "/xwiki/bin/get/XWiki/SuggestLuceneService?outputSyntax=plain&query=__INPUT__* AND type:attachment&nb=3&",
        icon : "/xwiki/resources/icons/silk/attach.gif",
        highlight:  false       },
                                {
        name : "Users",
        varname : 'input',
        script : "/xwiki/bin/get/XWiki/SuggestLuceneService?outputSyntax=plain&query=__INPUT__* AND object:XWiki.XWikiUsers&nb=3&",
        icon : "/xwiki/resources/icons/silk/user.gif",
        highlight:  false       },
